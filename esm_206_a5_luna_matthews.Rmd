...
to do:
  ...
  * Summary
  ...
  Citations: should pic ones go at bottom?
  Mack creek needs citation
...
Forrest conditions appears to have an effect on the total population of the Pacific giant salamander at Mack creek, but this does not appear to significantly effect what channels are most used. With regard to weights of the Pacific giant salamander, there is not a significant difference based on forest condition, however there appears to be a non-negligible significant difference between the mean weights in the channel classifications. Further pairwise comparisons for each channel are required to determine which of the channel classifications show statistically significant differences in weight.
